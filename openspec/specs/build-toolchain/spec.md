...
The project SHALL compile Kotlin source to JVM 17 bytecode, with `sourceCompatibility`, `targetCompatibility`, and `kotlin { jvmToolchain(17) }` all set to Java 17.
...
The `AGENTS.md` file SHALL accurately document JDK 25 as the required Java version for building this project.
